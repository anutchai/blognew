              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="settings">
                    <form wire:submit.prevent="UpdateProfile" wire:ignore.self class="form-horizontal">
                      <div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" wire:model="lastname" class="form-control" id="inputName2" placeholder="Lastname">
                        </div>
                      </div>
                      </div>
                      <div class="form-group row">
