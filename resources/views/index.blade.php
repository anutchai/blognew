...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 top-nav-social-lists text-lg-right col-lg-4 ml-lg-auto">
                    <ul class="mt-4 list-unstyled mt-lg-0">
                        <li>
                            <a href="#">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xs-12 col-sm-3 col-md-3">
                    ...
                    <div class="logo">
                        <a href="index.html">
                            <img src="{{Asset('Asset/Frontend/images/logos/logo.png')}}" alt="">
                            <!-- Replace Logo Here -->
                        </a>
                    </div>
                    <!-- End Logo -->
                ...
                <div class="col-xs-12 col-sm-9 col-md-9">
                    <div class="float-right top-ad-banner">
                        <a href="#">
                            <img src="{{Asset('Asset/Frontend/images/news/ad-pro.png')}}" class="img-fluid"
                                alt="banner-ads">
                        </a>
                    </div>
                </div>
    ...
    <div class="clearfix main-navbar bg-dark ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg site-main-nav navigation">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="ml-auto nav-search d-none d-lg-block">
                                <span id="search">
            ...
            <div class="row no-gutters">
                <div class="col-md-6 col-xs-12 col-lg-4">
                    <div class="featured-slider mr-md-3 mr-lg-3">
                        <div class="item"
                            style="background-image:url({{Asset('Asset/Frontend/images/news/img-1.jpg')}})">
                            <div class="post-content">
                                ...
                                <div class="mt-2 post-meta">
                                    <span class="posted-time"><i class="mr-2 fa fa-clock-o text-danger"></i>19 hours
                                        ago</span>
                ...
                <div class="col-md-6 col-xs-12 col-lg-4">
                    <div class="featured-slider mr-lg-3">
                        <div class="item"
                            style="background-image:url({{Asset('Asset/Frontend/images/news/img-2.jpg')}})">
                            <div class="post-content">
                ...
                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-4">
                    <div class="mt-3 row mt-lg-0">
                        <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                            <div class="post-featured-style"
                                style="background-image:url({{Asset('Asset/Frontend/images/news/news-02.jpg')}})">
                                <div class="post-content">
                        ...
                        <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                            <div class="post-featured-style"
                                style="background-image:url({{Asset('Asset/Frontend/images/news/news-04.jpg')}})">
                                <div class="post-content">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="news-style-one">
                        ...
                        <div class="news-style-one-slide">
                            <div class="item">
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-01.jpg')}}"
                                                alt="post-image" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                                        <h2 class="mt-3 post-title">
                                            <a href="single-post.html">Ex-Googler warns coding bootcamps are lacking</a>
                                        </h2>
                                        <div class="mb-2 post-meta">
                                            <span class="posted-time"><i class="mr-2 fa fa-clock-o"></i>5 hours
                                                ago</span>
                                            <span class="post-author">
                                                by
                                ...
                                <div class="clearfix mb-5 post-block-wrapper ">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-02.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="item">
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-03.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-04.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="item">
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-05.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-06.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="item">
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-07.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="clearfix mb-5 post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-08.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                    ...
                    <div class="news-style-two">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="clearfix post-block-wrapper">
                                    <div class="post-thumbnail">
                                        <a href="single-post.html">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-09.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="post-list-block m-top-0">
                                    <div class="clearfix post-block-wrapper post-float">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid"
                                                    src="{{Asset('Asset/Frontend/images/news/news-04.jpg')}}"
                                        ...
                                        <div class="post-content">
                                            ...
                                            <div class="post-meta">
                                                <span class="posted-time"><i class="mr-2 fa fa-clock-o"></i>7 hours
                                                    ago</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix post-block-wrapper post-float">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <div class="post-meta">
                                                <span class="posted-time"><i class="mr-2 fa fa-clock-o"></i>10 hours
                                                    ago</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix post-block-wrapper post-float">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <div class="post-meta">
                                                <span class="posted-time"><i class="mr-2 fa fa-clock-o"></i>11 hours
                                                    ago</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix post-block-wrapper post-float">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <div class="post-meta">
                                                <span class="posted-time"><i class="mr-2 fa fa-clock-o"></i>12 hours
                                                    ago</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="post-overlay-wrapper">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-15.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                                <div class="post-content">
                                    ...
                                    <div class="post-meta white">
                                        <span class="posted-time"><i class="mr-1 fa fa-clock-o"></i>17 jun,2019</span>
                                        <span> by </span>
                                        <span class="post-author">
                            ...
                            <div class="post-list-block">
                                <div class="post-block-wrapper post-float ">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta">
                                            <span class="posted-time"><i class="mr-1 fa fa-clock-o"></i>2 hours
                                                ago</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="post-block-wrapper post-float">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta">
                                            <span class="posted-time"><i class="mr-1 fa fa-clock-o"></i> 15 March ,
                                                2019</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="post-block-wrapper post-float">
                                    <div class="post-thumbnail">
                                        <a href="single-post.html">
                                            <img class="img-fluid"
                                                src="{{Asset('Asset/Frontend/images/news/news-11.jpg')}}"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta">
                                            <span class="posted-time"><i class="mr-1 fa fa-clock-o"></i> 5 hours
                                                ago</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="post-block-wrapper post-float">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta">
                                            <span class="posted-time"><i class="mr-1 fa fa-clock-o"></i> 17 June,
                                                2019</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mb-0 widget">
                            ...
                            <div class="post-slide">
                                <div class="item">
                                    <div class="clearfix post-overlay-wrapper">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid"
                                                    src="{{Asset('Asset/Frontend/images/news/news-16.jpg')}}"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="clearfix mt-3 post-overlay-wrapper">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid"
                                                    src="{{Asset('Asset/Frontend/images/news/news-18.jpg')}}"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="item ">
                                    <div class="clearfix post-overlay-wrapper">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid"
                                                    src="{{Asset('Asset/Frontend/images/news/news-17.jpg')}}"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                    ...
                                    <div class="clearfix mt-3 post-overlay-wrapper">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid"
                                                    src="{{Asset('Asset/Frontend/images/news/news-19.jpg')}}"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                        <div class="post-content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="block">
                        ...
                        <div class="clearfix post-overlay-wrapper">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-13.jpg')}}"
                                    alt="post-thumbnail" />
                            </div>
                        ...
                        <div class="post-list-block">
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-11.jpg')}}"
                                        alt="post-thumbnail" />
                            ...
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-04.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                                <div class="post-content">
                                    <h2 class="post-title title-sm">
                            ...
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-12.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="block">
                        ...
                        <div class="clearfix post-overlay-wrapper">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-08.jpg')}}"
                                    alt="post-thumbnail" />
                            </div>
                        ...
                        <div class="post-list-block">
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-03.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                            ...
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-01.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                            ...
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-06.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="block">
                        ...
                        <div class="clearfix post-overlay-wrapper">
                            <div class="post-thumbnail">
                                <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-05.jpg')}}"
                                    alt="post-thumbnail" />
                            </div>
                        ...
                        <div class="post-list-block">
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-10.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                            ...
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-07.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
                            ...
                            <div class="clearfix post-block-wrapper post-float">
                                <div class="post-thumbnail">
                                    <img class="img-fluid" src="{{Asset('Asset/Frontend/images/news/news-14.jpg')}}"
                                        alt="post-thumbnail" />
                                </div>
    ...
    <footer class="footer footer-main ">
        <div class="container">
            <div class="row justify-content-center">
                <div class="text-center col-md-8 col-sm-12 col-lg-6">
                    <a href="index.html"><img src="{{Asset('Asset/Frontend/images/logos/footer-logo.png')}}" alt=""
                            class="img-fluid"></a>
